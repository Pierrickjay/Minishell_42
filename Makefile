...
SRCS		+= execution/utils/free_1.c execution/utils/free_2.c execution/utils/free_3.c execution/utils/ft_setenv.c \
			...
			execution/parent.c execution/exec_1.c execution/exec_2.c execution/args.c execution/path.c \
			execution/child_1.c execution/child_2.c execution/vars.c \
