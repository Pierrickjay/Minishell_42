...
SRCS_LIBFT		:= char/ft_isalnum.c char/ft_isalpha.c char/ft_isascii.c char/ft_isdigit.c \
				...
				liste_chaine/ft_lstiter.c liste_chaine/ft_lstmap.c liste_chaine/ft_lstprint_type.c liste_chaine/ft_lstadd.c
...
SRCS		+= execution/utils/free_1.c execution/utils/free_2.c execution/utils/free_3.c execution/utils/ft_msg.c \
			...
			execution/builtins/ft_export.c execution/builtins/ft_export_bis.c execution/builtins/ft_cd.c execution/builtins/ft_cd_bis.c execution/builtins/ft_unset.c
