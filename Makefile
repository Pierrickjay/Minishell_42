...
SRCS		+= execution/env/ft_envi_add_back.c execution/env/ft_envi_last.c execution/env/ft_envi_new.c \
			...
			execution/builtins/builtins.c execution/builtins/ft_pwd.c execution/builtins/ft_echo.c execution/builtins/ft_env.c \
			...
			execution/struct/shell_1.c execution/struct/shell_2.c execution/struct/shell_3.c \
